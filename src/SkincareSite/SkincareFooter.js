export default function SkincareFooter({ store }) {
    ...
    <footer className="sk-footer">
      <div className="sk-footer-cols">
        <div className="sk-footer-brand">
          <p className="sk-footer-name">{store.name}</p>
          {store.about && <p className="sk-footer-about">{store.about}</p>}
        </div>

        <div>
          <p className="sk-footer-head">Contact</p>
        ...
        {socials.length > 0 && (
          <div>
            <p className="sk-footer-head">Follow</p>
            {socials.map((s) => (
        ...
        {store.address && (
          <div>
            <p className="sk-footer-head">Find us</p>
            <p className="sk-footer-address">{store.address}</p>
          </div>
        )}
      </div>
