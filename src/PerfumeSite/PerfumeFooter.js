export default function PerfumeFooter({ store }) {
  ...
  return (
    <footer className="pf-footer">
      <div className="pf-footer-top">
        <p className="pf-footer-name">{store.name}</p>
        {store.about && <p className="pf-footer-about">{store.about}</p>}
      </div>

      <div className="pf-footer-cols">
        <div>
          <p className="pf-footer-head">Contact</p>
        ...
        {socials.length > 0 && (
          <div>
            <p className="pf-footer-head">Follow</p>
            {socials.map((s) => (
        ...
        {store.address && (
          <div>
            <p className="pf-footer-head">Visit</p>
            <p className="pf-footer-address">{store.address}</p>
          </div>
        )}
      </div>
